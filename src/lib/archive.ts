...
export const RECORD_TYPES = [
  ...
  { value: "publication", label: "Publication / Printed Material" },
...
export const SUBTYPES: Record<string, readonly string[]> = {
  ...
  personal_papers: [
    ...
    "Miscellaneous Personal Paper",
  ],
  publication: [
    "Military Educational Material",
    "Pamphlet",
    "Bulletin / Notice",
    "Newsletter / Unit Publication",
    "Government Publication",
    "Brochure",
    "Guide / Handbook",
    "Map / Printed Guide",
    "Flyer",
    "Printed Song / Lyrics Sheet",
