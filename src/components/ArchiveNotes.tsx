...
/** Notes generated by the FFF flow carry the badge in the ledger. */
export function isFffNote(title: string | null) {
  return Boolean(title && title.trim().toUpperCase().startsWith("FFF"));
}
